...
def get_time_slot(dt):
    #Restituisce la chiave della fascia oraria se l'ora ricade in una fascia, altrimenti None
    hour = dt.hour
...
def is_non_weekdays(dt):
    return dt.weekday() in (0, 4) #scelta giorni settimanali
